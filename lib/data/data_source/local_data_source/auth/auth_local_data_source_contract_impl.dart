...
class AuthLocalDataSourceImpl implements AuthLocalDataSourceContract {
  ...
  Future<void> saveRefreshToken({required String refreshToken}) async {
    await SharedPrefHelper.setSecureString("refreshToken", refreshToken);
  }

  @override
  Future<String?> getRefreshToken() async {
    return SharedPrefHelper.getSecureString("refreshToken");
  }

  @override
  Future<void> deleteRefreshToken() async {
    SharedPrefHelper.removeSecureString("refreshToken");
  }
}
